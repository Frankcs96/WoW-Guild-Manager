        ...
        <div id="login-row" class="row justify-content-center align-items-center">
            <div id="login-column" class="col-md-6">
                <div id="login-box" class="col-md-12">
                    <form id="login-form" class="form" action="UpdateGuild" method="post">
                        <h3 class="text-center">Update your guild info</h3>
                        <div class="form-group">
                            <label for="guildName">Guild Name:</label><br>
                            <input type="text" name="guildName" id="guildName" class="form-control"
                                   required value="<%=userGuild.getGuildName()%>">
                        </div>
                        <div class="form-group">
                            <label for="guildServer">Server:</label><br>
                            <select class="form-control" id="guildServer" name="serverList">
                                <% for (Server server : serverList) {
                                    if (userGuild.getServerId() == server.getServerId()) {
                                        out.print("<option  selected=\"selected\" value = \"" + server.getServerId() + "\">"
